...
Register critical data, IT systems, data classification and processess, so you can identify and evaluate risk factors asociated to such components and desing controls to protect you data.
